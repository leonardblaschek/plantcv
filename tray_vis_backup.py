...
def main():
    ...
    a_thresh, _ = pcv.threshold.custom_range(img=crop_img, lower_thresh=[0,0,0], upper_thresh=[255,120,255], channel='LAB')
    b_thresh, _ = pcv.threshold.custom_range(img=crop_img, lower_thresh=[0,0,135], upper_thresh=[255,255,255], channel='LAB')
    h_thresh, _ = pcv.threshold.custom_range(img=crop_img, lower_thresh=[42,0,0], upper_thresh=[60,255,255], channel='HSV')
